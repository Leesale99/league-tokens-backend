...
7. Report the issue number/title, snapshot path, branch name, any prior-art hits from the knowledge base, and that the issue is ready for context gathering with `/gather-context <issue>`.
