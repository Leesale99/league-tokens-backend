...
1. Read `docs/issue-workflows/$1/issue.md`.
...
1. Write `docs/issue-workflows/$1/synthesis-brief.md` pointing at the reports and the `context-synthesizer` role contract.
2. Dispatch `scripts/issue-workflow/v2/dispatch.sh $1 context-synthesizer docs/issue-workflows/$1/synthesis-brief.md`.
