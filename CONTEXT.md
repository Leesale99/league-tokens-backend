...
| Currency | Spec 1 | `ledger` (`wallet.currency`) | **in-game currency, NOT fiat** — single source of truth for balance |
...
| `Ledger` | ADR-0001 | context | sole balance authority (currency + tokens) |
...
| `player_TB` | Spec 8 | `rankings` | projection of burn/final-burn events, NOT currency |
...
|---|---|---|
| 0001 | `docs/adr/0001-bounded-contexts.md` | Module boundaries, cross-context calls, Ledger as sole balance authority |
...
| 0010 | `docs/adr/0010-decimal.md` | `shopspring/decimal`, NUMERIC(38,6), round-half-up, lint rules |
